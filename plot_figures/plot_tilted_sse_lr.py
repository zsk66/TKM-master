...
for dataset_name in dataset_names:
    ...
    for lr in lr_list:
        ...
        ifkm_tilted_sse_lr.append([sum(col) / len(col) for col in zip(*ifkm_tilted_sse_id)])
    ifkm_tilted_sse_t[dataset_name] = ifkm_tilted_sse_lr
...
plt.savefig("../results/tilted_sse_lr.pdf")
