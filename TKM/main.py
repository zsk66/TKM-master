import numpy as np
import pandas as pd
from utils import read_data, cluster_variances, setup_seed
from update import tilted_mini_batch_kmeans
            ...
            for t in t_list:
                for num_epoch in epoch_list:
                    for lr in lr_list:
                        ...
                        centroids, labels, SSE, tilted_SSE = tilted_mini_batch_kmeans(data, args, t, k, num_epoch, lr)
