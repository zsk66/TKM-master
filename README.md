# TKM-master
Python code for paper "Efficient $k$-means with Individual Fairness via Exponential Tilting"
## Introduction

This repo holds the source code and scripts for reproducing the key experiments of our paper: Efficient $k$-means with Individual Fairness via Exponential Tilting.
...
<img src = [文件名 . 图片格式](https://github.com/zsk66/TKM-master/files/14646908/k.2_visualization.pdf) / >
